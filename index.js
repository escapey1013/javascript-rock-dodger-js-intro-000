  ...
  function moveRock() {
     ...
     */
     ...
     if (checkCollision(rock)) {
       ...
       rock.remove(); //some kind of error here
     }
    /**
     * Otherwise, if the rock hasn't reached the bottom of
     * the GAME, we want to move it again.
...
function moveDodgerLeft(e) {
   ...
   * (mabye 4 pixels?). Use window.requestAnimationFrame()!
   */
   var leftStart = DODGER.style.left.replace('px', '')
   var beginning = 0
   if (leftStart > 3) {
     function step() {
       DODGER.style.left = `${leftStart -= 4}px`
       beginning += 1
       if (beginning < 4) {
...
function moveDodgerRight(e) {
   ...
   * (mabye 4 pixels?). Use window.requestAnimationFrame()!
   */
   var rightStart = DODGER.style.left.replace('px', '')
   var beginning = 0
   if (rightStart < 357) {
     function step() {
       DODGER.style.left = `${rightStart += 4}px`
       beginning += 1
       if (beginning < 4) {
         window.requestAnimationFrame(step);
       }
